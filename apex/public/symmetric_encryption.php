      ...
      <form action="" method="post">
        <div>
          ...
          <select name="encode_algorithm">
            <option value="AES-256-CBC" <?php if($aes256) echo 'selected="selected"'; ?> >AES-256-CBC</option>
            <option value="AES-128-CBC" <?php if($aes128) echo 'selected="selected"'; ?> >AES-128-CBC</option>
            <option value="AES-192-CBC" <?php if($aes192) echo 'selected="selected"'; ?> >AES-192-CBC</option>
            <option value="DES-EDE3-CBC" <?php if($des) echo 'selected="selected"'; ?> >DES-EDE3-CBC</option>
            <option value="BF-CBC" <?php if($bf) echo 'selected="selected"'; ?> >BF-CBC</option>
          </select>
        </div>
        <div>
